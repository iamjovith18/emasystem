          ...
          <div class="row-fluid">
            <div class="span12">
              <ul class="site-stats">
                ...
                @else
                <a href="{{route('accessory')}}"><li class="bg_lr"><i class="icon-desktop"></i> <strong>{{$total_kb}}</strong> <strong><span class="label label-warning">"are running out of stock!"</span><h5>Total Keyboards</h5></strong></li></a>
                @endif
                @if($total_m > 10)
